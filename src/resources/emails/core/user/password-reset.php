...
<p style="color:#5c6773;font-size:15px;line-height:1.7;margin:0 0 18px;">
    abbiamo ricevuto una richiesta di cambio password. Usa il pulsante qui sotto per impostarne una nuova.
</p>
...
<p style="color:#5c6773;font-size:14px;line-height:1.7;margin:0 0 16px;">
    Il link scade tra <?= (int) $expiresMinutes ?> minuti. Se non hai richiesto tu il cambio password, ignora questa email.
</p>
