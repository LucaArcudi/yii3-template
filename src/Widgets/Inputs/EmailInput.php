...
final class EmailInput extends BaseInput
{
    public static function render(
        ...
        $resolvedInputAttributes = InputValidation::inputAttributes('email', $inputAttributes, $validationRules);
        if ($resolvedInputAttributes !== []) {
            $field = $field->addInputAttributes($resolvedInputAttributes);
        }

        return (string) self::decorate($field, 'email', $icon, $hint, $validationErrors);
    }
