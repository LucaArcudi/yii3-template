...
final class PermissionFilter implements RulesProviderInterface
{
    ...
    public function fill(array $data): self
    {
        ...
        $this->groupName = $this->stringValue($data['group_name'] ?? null, 100);
        $this->weight = $this->stringValue($data['weight'] ?? null, 20);
    ...
    public function toArray(?Result $result = null): array
    {
        ...
        if ($this->groupName !== null && $result->isPropertyValid('groupName')) {
            $filters['group_name'] = $this->groupName;
        }

        if ($this->weight !== null && $result->isPropertyValid('weight')) {
            $filters['weight'] = (int) $this->weight;
        }
